...
function FillRectangle_ImgData(ImgData, x, y, w, h, raw){
...
onmessage = function(e) {
    ...
    console.log('Worker recieved request to render: ', formula, ' at fidel=', cell_size, 'px');
...
*/
	    ...
	    */
	    ...
	    FillRectangle_ImgData(myImg, x_location_px, y_location_px, cell_size, cell_size, my_h);
